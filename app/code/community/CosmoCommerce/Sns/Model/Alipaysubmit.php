...
class CosmoCommerce_Sns_Model_Alipaysubmit extends CosmoCommerce_Sns_Model_Alipayabstract{
    ...
    function buildRequestForm( $method, $button_name) {
        ...
        //必填
        //必填，页面跳转同步通知页面路径
        $return_url = Mage::getBaseUrl()."sns/alipay/redirect";
