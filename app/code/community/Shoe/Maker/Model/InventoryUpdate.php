 ...
 * Time: 3:21 PM
 */
class Shoe_Maker_Model_InventoryUpdate extends  Shoe_Maker_Model_UpdateBase{
...
//        }
    ...
    public function validate(){
        ...
        if( count(glob($receivedDirectory . 'inventory_product_update*')) == 0 ){
            echo "inventory_product_update* file not find. exit... There is no xml file to be executed \n";
            return true;
        }
        $filename = rtrim(basename(shell_exec('ls -t -r ' . $receivedDirectory . 'inventory_product_update* | head --lines 1')));
