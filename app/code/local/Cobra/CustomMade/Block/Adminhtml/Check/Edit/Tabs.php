...
class Cobra_CustomMade_Block_Adminhtml_Check_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    public function __construct()
    {
        ...
        $this->setTitle(Mage::helper('custommade')->__('Employee Information'));
    }

    protected function _beforeToHtml()
    {
        $this->addTab('form_section111', array(
                'label' => Mage::helper('custommade')->__('Employee Information'),
                'title' => Mage::helper('custommade')->__('Employee Information'),
