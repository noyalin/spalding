...
class Cobra_CustomClothes_Helper_Imagehandler extends Mage_Core_Helper_Abstract
{
    ...
    {
        $path = Mage::getBaseDir() . '/media/customclothes/tmp/';
        $url = Mage::getBaseUrl() . 'media/customclothes/tmp/';
        $cover_show = Mage::getDesign()->getSkinUrl('images/customClothes/' . $sku . '/' . $position . '_show.png');
        $cover_print = Mage::getDesign()->getSkinUrl('images/customClothes/' . $sku . '/' . $position . '_print.png');
        ...
        if ($img_info) {
            ...
            switch ($img_type) {
                case IMAGETYPE_JPEG:
                    ...
                    Mage::log('IMAGETYPE_JPEG date = '.$date);
                    //$date = uniqid();
                ...
                case IMAGETYPE_PNG:
                    $date = Mage::getModel('core/date')->date('YmdHis').uniqid();
                    Mage::log('IMAGETYPE_PNG date = '.$date);
                    $img = imagecreatefromstring($data_decode);
