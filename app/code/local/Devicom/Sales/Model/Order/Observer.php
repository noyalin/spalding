...
class Devicom_Sales_Model_Order_Observer {

	public function __construct() {

	}
    public function post_new_order($observer) {

    }
	public function post_new_order_bak($observer) {
		$html_root = dirname(dirname(dirname(dirname(dirname(dirname(dirname(dirname(__FILE__))))))));
