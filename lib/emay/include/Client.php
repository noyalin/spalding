...
class Client{
	 ...
	 * @return int 操作结果状态码
	 */
	function sendSMS($mobiles=array(),$content,$sendTime='',$addSerial='',$charset='UTF-8',$priority=5,$smsId=8888)
	{
	 ...
	 * @return int 操作结果状态码
	 */
	function sendVoice($mobiles=array(),$content,$sendTime='',$addSerial='',$charset='UTF-8',$priority=5,$smsId=8888)
	{
