...
! function (e) {
    ...
    function o() {
        d.$wndw = e(window), d.$html = e("html"), d.$body = e("body"), d.$allMenus = e(), e.each([c, u, p], function (e, t) {
            ...
            return e + ".mm"
        }, p.add("toggle open opening opened close closing closed update setPage setSelected transitionend touchstart touchend mousedown mouseup click keydown keyup resize"), e[a]._c = c, e[a]._d = u, e[a]._e = p, e[a].glbl = d, e[a].useOverflowScrollingFallback(h)
    }
    ...
    if (!e[a]) {
            ...
            _initPanles: function () {
                ...
                o.each(function (n) {
                    ...
                    if (n.data(u.parent, s), s.parent().is("." + c.list)) {
                        ...
                        i.is("a") || a.addClass(c.fullsubopen), "horizontal" == t.direction && o.prepend('<li class="' + c.subtitle + '"><a class="' + c.subclose + '" href="#' + l.attr("id") + '">' + i.text() + "</a></li>"); /* Added (Devicom). Adds same href value as sub-open button */
                        i.attr("href", '#' + n.attr("id"));
                    }
                });
        ...
        function () {
            var t = window.document,
                ...
                s = "ontouchstart" in t,
                i = "WebkitOverflowScrolling" in t.documentElement.style,
                l = function () {
    ...
    e[a].prototype["_addon_" + o] = function () {
        ...
        if (e.fn.hammer) {
            ...
            if ("boolean" == typeof r && (r = {
                ...
                $dragNode = this.__valueOrFn(r.pageNode, this.$menu, s.$page), "string" == typeof $dragNode && ($dragNode = e($dragNode)), $dragNode.hammer().on(i.touchstart + " " + i.mousedown, function (e) {
                ...
                }).on(u.events + " " + i.dragend, function (e) {
                    g > 0 && (e.gesture.preventDefault(), e.stopPropagation())
                }).on(u.events, function (e) {
                    var a = u.negative ? -e.gesture[u.delta] : e.gesture[u.delta];
                    if (p = a > c ? u.open_dir : u.close_dir, c = a, c > r.threshold && 1 == g) {
                    ...
                    if (2 == g) {
                        ...
                        s.$html.removeClass(d.dragging), e.css(n.opts.position, ""), p == u.open_dir ? n._openFinish() : n.close()
                    }
                    g = 0
                })
            }
...
! function (e) {
    ...
    e[l].prototype["_addon_" + s] = function () {
        var a = this,
            ...
            n = e[l]._c,
            t = (e[l]._d, e[l]._e);
        if (n.add("collapsed"), n.add("fixedlabels original clone"), t.add("updatelabels position scroll"), e[l].support.touch && (t.scroll += " " + t.mm("touchmove")), "boolean" == typeof o && (o = {
            collapse: o
