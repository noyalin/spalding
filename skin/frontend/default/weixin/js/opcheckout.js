...
Checkout.prototype = {
    ...
    gotoSection: function(section)
    {
		...
		scrollToElement('#opc-' + section, 50);
    },
...
//        //this.accordion.openNextSection(true);
    ...
    back: function(e){
        ...
        for (section in this.accordion.sections) {
            ...
            if (this.accordion.sections[section].id == this.accordion.currentSection && this.accordion.sections[t]) {
                if (e) {
                    Element.addClassName(this.accordion.sections[t], "allow")
                }
                this.accordion.openSection(this.accordion.sections[t]);
				scrollToElement(this.accordion.sections[t], 50);
				return;
            }
        }
...
//PCN BEGIN
	var parentElement = document.getElementById("payment-buttons-container");
	if (parentElement) {
	    parentElement.childNodes[3].style.display = "";
	}
//PCN END
    },
