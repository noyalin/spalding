...
function json_to_xml($json){
    ...
    $xml_str .= $json_str['@attributes']['updateType'];
    $xml_str .='"><Simple>';
    foreach($json_str['Simple']['Product'] as $product){
        $xml_str .='<Product><Sku>';
        $xml_str .=$product['Sku'];
        $xml_str .='</Sku><Quantity>';
        $xml_str .=$product['Quantity'];
        $xml_str .='</Quantity><Eursize>';
        $xml_str .=$product['Eursize'];
        $xml_str .='</Eursize></Product>';
