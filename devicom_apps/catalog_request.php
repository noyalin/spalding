	...
	try {
		...
		switch ($updateType) {
			...
			case 1://INCREMENTAL PRODUCT
				...
				break;
			case 2://CATEGORY POSITIONING
				$filename = 'category_positioning_update_' . $realTime[5] . $realTime[4] . $realTime[3] . '_' . $realTime[2] . $realTime[1] . $realTime[0] . substr(microtime(), 2, 3) . '.xml';
				break;
			case 3://INCREMENTAL CATEGORY
				$filename = 'category_update_' . $realTime[5] . $realTime[4] . $realTime[3] . '_' . $realTime[2] . $realTime[1] . $realTime[0] . substr(microtime(), 2, 3) . '.xml';
				break;
			default:
